...
public class SearchCocktailCategoryIntentHandlerTest {

    private SearchCocktailCategoryIntentHandler handler;

    @Before
    public void setup() {
        handler = new SearchCocktailCategoryIntentHandler();
    }
